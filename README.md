This Arduino sketch accepts MIDI note 36 (C1) on MIDI channel 16 and will transmit a 15 ms pulse that can be used as an analog sync signal to slave Volcas, 
